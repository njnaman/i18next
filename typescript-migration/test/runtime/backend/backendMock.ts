...
class BackendMock implements BackendModule {
    ...
    public created: Record<Language, unknown> = {};
    ...
    readMulti(languages: Language[], namespaces: Namespace[], callback: MultiReadCallback) {
    ...
    create(languages: Language[], namespace: Namespace, key: string, fallbackValue: string, callback: (err: Error | null, data?: unknown) => void, options: InitOptions) {
        languages.forEach((l) => {
