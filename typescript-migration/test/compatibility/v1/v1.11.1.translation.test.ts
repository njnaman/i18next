...
} from './v1.i18nInstance';
import * as compat from './v1';
...
describe('v1.11.1 translation', () => {
  ...
  describe('keys with non supported values', () => {
    ...
    it('it should stringify first on number key', () => {
      expect(i18n.t(1)).toBe(i18n.t('1'));
      expect(i18n.t(1.1)).toBe(i18n.t('1.1'));
    });
  });
  ...
  describe('resource is missing', () => {
    ...
    it('it should return key', () => {
      expect(i18n.t('missing')).toBe('translation:missing');
    });

    it('it should return default value if set', () => {
      expect(i18n.t('missing', { defaultValue: 'defaultOfMissing' })).toBe('defaultOfMissing');
    });

    describe('with namespaces', () => {
      it('it should return key', () => {
        expect(i18n.t('translate:missing')).toBe('translate:missing');
      });

      it('it should return default value if set', () => {
        expect(i18n.t('translate:missing', { defaultValue: 'defaultOfMissing' })).toBe(
          'defaultOfMissing',
        );
      });
      ...
      describe('and function parseMissingKey set', () => {
        ...
        it('it should parse key', () => {
          expect(i18n.t('translate:missing')).toBe('missing');
          expect(i18n.t('translate:somenesting.missing')).toBe('missing');
        });
  ...
  describe('Check for existence of keys', () => {
    ...
    it('it should exist', () => {
      expect(i18n.exists('iExist')).toBe(true);
    });

    it('it should not exist', () => {
      expect(i18n.exists('iDontExist')).toBe(false);
    });
  ...
  describe('resource string is null', () => {
    ...
    it('it should translate value', () => {
      expect(i18n.t('key1')).toBe(null);
      expect(i18n.t('key2')).toEqual({ key3: null });
    });
  });
  ...
  describe('with option fallbackOnNull = true', () => {
    ...
    it('it should translate to fallback value', () => {
      expect(i18n.t('key1')).toBe('fallbackKey1');
      expect(i18n.t('key2.key3')).toEqual('fallbackKey3');
    });
  });
  ...
  describe('key with empty string set to fallback if empty', () => {
    describe('missing on unspecific', () => {
      ...
      it('it should translate correctly', () => {
        expect(i18n.t('empty')).toBe('translation:empty');
      });
    });
  ...
  describe('resource key as array', () => {
    ...
    describe('when none of the keys exist', () => {
      it('return the same value as translating the last non-existent key', () => {
        expect(i18n.t(['nonexistent1', 'nonexistent2'], { name: 'Joe' })).toBe(
    ...
    describe('when one of the keys exist', () => {
      it('return the same value as translating the one existing key', () => {
        expect(i18n.t(['nonexistent1', 'existing2'], { name: 'Joe' })).toBe(
    ...
    describe('when two or more of the keys exist', () => {
      it('return the same value as translating the first existing key', () => {
        expect(i18n.t(['nonexistent1', 'existing2', 'existing1'], { name: 'Joe' })).toBe(
          i18n.t('existing2', { name: 'Joe' }),
        );
      });
    });
  ...
  describe('resource string as array', () => {
    ...
    it('it should translate nested value', () => {
      expect(i18n.t('testarray')).toBe('title\ntext');
    });
  });
  ...
  describe('accessing tree values', () => {
    describe('basic usage', () => {
      ...
      it('it should return nested string as usual', () => {
        expect(i18n.t('test.simple_en-US')).toBe('ok_from_en-US');
      });

      it('it should not fail silently on accessing an objectTree', () => {
        expect(i18n.t('test')).toBe("key 'test (en-US)' returned an object instead of string.");
      });
    });
    ...
    describe('optional return an objectTree for UI components,...', () => {
      describe('with init flag', () => {
        ...
        it('it should return objectTree applying options', () => {
          expect(i18n.t('test_en_US', { replace: 'two' })).toEqual({ res_en_US: 'added two' });
          expect(i18n.t('test_en_US', { replace: 'three' })).toEqual({ res_en_US: 'added three' });
          expect(i18n.t('test_en_US', { replace: 'four' })).toEqual({ res_en_US: 'added four' });

          // from fallback
          expect(i18n.t('test_dev', { replace: 'two' })).toEqual({ res_dev: 'added two' });
        });
      });
      ...
      describe('with flag in options', () => {
        ...
        it('it should return objectTree', () => {
          expect(i18n.t('test', { returnObjectTrees: true, replace: 'two' })).toEqual({
            res: 'added two',
            id: 0,
          ...
          // expect(i18n.t('test', { returnObjectTrees: true, replace: 'three' })).toEqual({ 'res': 'added three' });
          // expect(i18n.t('test', { returnObjectTrees: true, replace: 'four' })).toEqual({ 'res': 'added four' });
        });
      });
    });
  });
  ...
  describe('resource nesting', () => {
    describe('basic usage', () => {
      ...
      it('it should translate nested value', () => {
        expect(i18n.t('nesting1')).toBe('1 2 3');
      });

      it('it should apply nested value on defaultValue', () => {
        expect(i18n.t('nesting_default', { defaultValue: '0 $t(nesting1)' })).toBe('0 1 2 3');
      });
    });
    ...
    describe('with setting new options', () => {
      ...
      it('it should translate nested value and set new options', () => {
        expect(i18n.t('nesting1', { count: 2, girls: 3 })).toBe('3 girls and 2 boys');
        expect(i18n.t('nesting1', { count: 1, girls: 3 })).toBe('3 girls and 1 boy');
      });
    });
  });
  ...
  describe('resource nesting with multiple namespaces and fallbackNS', () => {
    ...
    it('it should translate nested value', () => {
      expect(i18n.t('translation1:nesting1')).toBe('1 2 3');
    });
  });
  ...
  describe('interpolation - replacing values inside a string', () => {
    describe('default i18next way', () => {
      ...
      it('it should replace passed in key/values', () => {
        expect(i18n.t('interpolationTest1', { toAdd: 'something' })).toBe('added something');
        expect(i18n.t('interpolationTest1', { toAdd: null })).toBe('added ');
        // expect(i18n.t('interpolationTest1', {})).toBe('added '); // does not work anymore since removal of compatibilityAPI === v1
        expect(i18n.t('interpolationTest2', { toAdd: 'something' })).toBe(
          'added something something twice',
        );
        expect(i18n.t('interpolationTest3', { child: { one: '1', two: '2' } })).toBe(
          'added 1 2',
        );
        expect(i18n.t('interpolationTest4', { child: { grandChild: { three: '3' } } })).toBe(
          'added 3',
        );
      });

      it('it should replace passed in key/values in replace member', () => {
        expect(i18n.t('interpolationTest1', { replace: { toAdd: 'something' } })).toBe(
          'added something',
        );
        expect(i18n.t('interpolationTest2', { replace: { toAdd: 'something' } })).toBe(
          'added something something twice',
        );
        expect(
      ...
      it('it should not escape HTML', () => {
        expect(i18n.t('interpolationTest1', { toAdd: '<html>' })).toBe('added <html>');
      });
      ...
      it('it should replace passed in key/values on defaultValue', () => {
        ...
        ).toBe('added something');
      });

      it('it should escape dollar signs in replacement values', () => {
        expect(i18n.t('interpolationTest1', { toAdd: '$&' })).toBe('added $&');
      });
    });
    ...
    describe('default i18next way - different prefix/suffix via options', () => {
      ...
      it('it should replace passed in key/values', () => {
        ...
        ).toBe('added something something twice');
        expect(
    ...
    describe('default i18next way - with escaping interpolated arguments per default', () => {
      ...
      it('it should not escape when HTML is suffixed', () => {
        expect(i18n.t('interpolationTest5', { toAdd: '<html>' })).toBe('added <html>');
        expect(i18n.t('interpolationTest6', { child: { one: '<1>' } })).toBe('added <1>');
      });

      it('it should support both escaping and not escaping HTML', () => {
        expect(
          i18n.t('interpolationTest7', { toAdd: '<html>', escapeInterpolation: true }),
        ).toBe('added <html> &lt;html&gt;');
      });
    ...
    describe('default i18next way - with escaping interpolated arguments per default via options', () => {
      ...
      it('it should escape dollar signs in replacement values', () => {
        expect(i18n.t('interpolationTest1', { toAdd: '$&', escapeInterpolation: true })).toBe(
          'added $&amp;',
        );
      });
    });
    ...
    describe('using sprintf', () => {
      ...
      it('it should replace passed in key/values', () => {
        ...
        ).toBe('The first 4 letters of the english alphabet are: a, b, c and d');
        expect(
          i18n.t('interpolationTest2', {
            postProcess: 'sprintf',
            sprintf: { users: [{ name: 'Dolly' }, { name: 'Molly' }, { name: 'Polly' }] },
          }),
        ).toBe('Hello Dolly, Molly and Polly');
      });

      it('it should recognize the sprintf syntax and automatically add the sprintf processor', () => {
        expect(i18n.t('interpolationTest1', 'a', 'b', 'c', 'd')).toBe(
          'The first 4 letters of the english alphabet are: a, b, c and d',
        );
        expect(i18n.t('interpolationTest3', 'z')).toBe(
          'The last letter of the english alphabet is z',
        );
        expect(i18n.t('interpolationTest4', 0)).toBe('Water freezes at 0 degrees');
      });
    });
    ...
    describe('with default variables', () => {
      ...
      it('it should use default variable', () => {
        expect(i18n.t('Hello __name__')).toBe('Hello John');
      });

      it('it should replace default variable', () => {
        expect(i18n.t('Hello __name__', { name: 'Ben' })).toBe('Hello Ben');
      });
    });
  });
  ...
  describe('plural usage', () => {
    describe('basic usage - singular and plural form', () => {
      ...
      it('it should provide correct plural or singular form', () => {
        expect(i18n.t('pluralTest', { count: 0 })).toBe('plural');
        expect(i18n.t('pluralTest', { count: 1 })).toBe('singular');
        expect(i18n.t('pluralTest', { count: 2 })).toBe('plural');
        expect(i18n.t('pluralTest', { count: 7 })).toBe('plural');
      });

      it('it should provide correct plural or singular form with interpolation', () => {
        expect(i18n.t('pluralTestWithCount', { count: 0 })).toBe('0 items');
        expect(i18n.t('pluralTestWithCount', { count: 1 })).toBe('1 item');
        expect(i18n.t('pluralTestWithCount', { count: 7 })).toBe('7 items');
      });

      it('it should provide correct plural or singular form for second namespace', () => {
        expect(i18n.t('ns.2:pluralTest', { count: 0 })).toBe('plural from ns.2');
        expect(i18n.t('ns.2:pluralTest', { count: 1 })).toBe('singular from ns.2');
        expect(i18n.t('ns.2:pluralTest', { count: 2 })).toBe('plural from ns.2');
        expect(i18n.t('ns.2:pluralTest', { count: 7 })).toBe('plural from ns.2');
      });

      it('it should provide correct plural or singular form for second namespace with interpolation', () => {
        expect(i18n.t('ns.2:pluralTestWithCount', { count: 1 })).toBe('1 item from ns.2');
        expect(i18n.t('ns.2:pluralTestWithCount', { count: 7 })).toBe('7 items from ns.2');
      });
    });
    ...
    describe('fallback on count with non-plurals', () => {
      ...
      it('it should provide correct singular form', () => {
        expect(i18n.t('pluralTestWithCount', { count: 0 })).toBe('0 item');
        expect(i18n.t('pluralTestWithCount', { count: 1 })).toBe('1 item');
        expect(i18n.t('pluralTestWithCount', { count: 7 })).toBe('7 item');
      });

      it('it should provide correct singular form for second namespace', () => {
        expect(i18n.t('ns.2:pluralTestWithCount', { count: 1 })).toBe('1 item from ns.2');
        expect(i18n.t('ns.2:pluralTestWithCount', { count: 7 })).toBe('7 item from ns.2');
      });
    });
    ...
    describe('Plurals with passing lng to translation function', () => {
      ...
      it('should return the correct string for key', () => {
        expect(i18n.t('pluralTest', { count: 12, lng: 'nl' })).toBe('items');
        expect(i18n.t('pluralTest', { count: 0, lng: 'nl' })).toBe('items');
      });

      it('should return the correct string for key with count interpoation', () => {
        expect(i18n.t('pluralTestWithCount', { count: 12, lng: 'nl' })).toBe('12 items');
        expect(i18n.t('pluralTestWithCount', { count: 0, lng: 'nl' })).toBe('0 items');
      });
    });
    ...
    describe('basic usage 2 - singular and plural form in french', () => {
      ...
      it('it should provide correct plural or singular form', () => {
        expect(i18n.t('pluralTest', { count: 0 })).toBe('singular');
        expect(i18n.t('pluralTest', { count: 1 })).toBe('singular');
        expect(i18n.t('pluralTest', { count: 2 })).toBe('plural');
        expect(i18n.t('pluralTest', { count: 7 })).toBe('plural');
      });
    ...
    describe('extended usage - multiple plural forms - ar', () => {
      ...
      it('it should provide correct plural forms', () => {
        expect(i18n.t('key', { count: 0 })).toBe('zero');
        expect(i18n.t('key', { count: 1 })).toBe('singular');
        expect(i18n.t('key', { count: 2 })).toBe('two');
        expect(i18n.t('key', { count: 3 })).toBe('few');
        expect(i18n.t('key', { count: 4 })).toBe('few');
        expect(i18n.t('key', { count: 104 })).toBe('few');
        expect(i18n.t('key', { count: 11 })).toBe('many');
        expect(i18n.t('key', { count: 99 })).toBe('many');
        expect(i18n.t('key', { count: 199 })).toBe('many');
        expect(i18n.t('key', { count: 100 })).toBe('plural');
      });
    });
    ...
    describe('extended usage - multiple plural forms - ru', () => {
      ...
      it('it should provide correct plural forms', () => {
        expect(i18n.t('key', { count: 0 })).toBe('0,5,6');
        expect(i18n.t('key', { count: 1 })).toBe('1,21,31');
        expect(i18n.t('key', { count: 2 })).toBe('2,3,4');
        expect(i18n.t('key', { count: 3 })).toBe('2,3,4');
        expect(i18n.t('key', { count: 4 })).toBe('2,3,4');
        expect(i18n.t('key', { count: 104 })).toBe('2,3,4');
        expect(i18n.t('key', { count: 11 })).toBe('0,5,6');
        expect(i18n.t('key', { count: 24 })).toBe('2,3,4');
        expect(i18n.t('key', { count: 25 })).toBe('0,5,6');
        expect(i18n.t('key', { count: 99 })).toBe('0,5,6');
        expect(i18n.t('key', { count: 199 })).toBe('0,5,6');
        expect(i18n.t('key', { count: 100 })).toBe('0,5,6');
      });
    });
    ...
    describe('extended usage - ask for a key in a language with a different plural form', () => {
      ...
      it('it should provide translation for passed in language with 1 item', () => {
        expect(i18n.t('key', { lng: 'en', count: 1 })).toBe('singular_en');
      });

      it('it should provide translation for passed in language with 2 items', () => {
        expect(i18n.t('key', { lng: 'en', count: 2 })).toBe('plural_en');
      });
    });
  });
  ...
  describe.skip('[WONT FIX - FIND A BETTER SOLUTION]indefinite article usage', () => {
    describe('basic usage - singular, plural and indefinite', () => {
      ...
      it('it should provide the indefinite article when requested for singular forms', () => {
        expect(i18n.t('thing')).toBe('__count__ thing');
        expect(i18n.t('thing', { indefinite_article: true })).toBe('A thing');
        expect(i18n.t('thing', { count: 1 })).toBe('1 thing');
        expect(i18n.t('thing', { count: 5 })).toBe('5 things');
        expect(i18n.t('thing', { count: 1, indefinite_article: true })).toBe('A thing');
        expect(i18n.t('thing', { count: 5, indefinite_article: true })).toBe('5 things');
      });

      it('it should provide the indefinite article when requested for singular forms for second namespace', () => {
        expect(i18n.t('ns.2:thing', { count: 1 })).toBe('1 thing from ns.2');
        expect(i18n.t('ns.2:thing', { count: 5 })).toBe('5 things from ns.2');
        expect(i18n.t('ns.2:thing', { count: 1, indefinite_article: true })).toBe(
          'A thing from ns.2',
        );
        expect(i18n.t('ns.2:thing', { count: 5, indefinite_article: true })).toBe(
          'Some things from ns.2',
        );
      });

      it('it should provide the right indefinite translations from the third namespace', () => {
        expect(i18n.t('ns.3:thing', { count: 5 })).toBe('5 things');
        expect(i18n.t('ns.3:thing', { count: 1, indefinite_article: true })).toBe('A thing');
        expect(i18n.t('ns.3:thing', { count: 5, indefinite_article: true })).toBe(
          'Some things',
        );
      });
    });
    ...
    describe('extended usage - indefinite articles in languages with different plural forms', () => {
      ...
      it('it should provide the correct indefinite articles', () => {
        expect(i18n.t('key', { count: 1 })).toBe('1 thing');
        expect(i18n.t('key', { count: 5 })).toBe('5 thing');
        expect(i18n.t('key', { count: 1, indefinite_article: true })).toBe('a thing');
        expect(i18n.t('key', { count: 5, indefinite_article: true })).toBe('a thing');
      });
    });
  });
  ...
  describe('context usage', () => {
    describe('basic usage', () => {
      ...
      it('it should provide correct context form', () => {
        expect(i18n.t('friend_context')).toBe('A friend');
        expect(i18n.t('friend_context', { context: '' })).toBe('A friend');
        expect(i18n.t('friend_context', { context: 'male' })).toBe('A boyfriend');
        expect(i18n.t('friend_context', { context: 'female' })).toBe('A girlfriend');
      });

      it('it should provide correct context form for second namespace', () => {
        expect(i18n.t('ns.2:friend_context')).toBe('A friend from ns2');
        expect(i18n.t('ns.2:friend_context', { context: '' })).toBe('A friend from ns2');
        expect(i18n.t('ns.2:friend_context', { context: 'male' })).toBe('A boyfriend from ns2');
        expect(i18n.t('ns.2:friend_context', { context: 'female' })).toBe(
    ...
    describe('extended usage - in combination with plurals', () => {
      ...
      it('it should provide correct context with plural forms', () => {
        expect(i18n.t('friend_context', { count: 1 })).toBe('1 friend');
        expect(i18n.t('friend_context', { context: '', count: 1 })).toBe('1 friend');
        expect(i18n.t('friend_context', { context: 'male', count: 1 })).toBe('1 boyfriend');
        expect(i18n.t('friend_context', { context: 'female', count: 1 })).toBe('1 girlfriend');

        expect(i18n.t('friend_context', { count: 10 })).toBe('10 friends');
        expect(i18n.t('friend_context', { context: '', count: 10 })).toBe('10 friends');
        expect(i18n.t('friend_context', { context: 'male', count: 10 })).toBe('10 boyfriends');
        expect(i18n.t('friend_context', { context: 'female', count: 10 })).toBe(
          '10 girlfriends',
        );
      });
    });
  ...
  describe('with passed in languages different from set one', () => {
    ...
    it('it should provide translation for passed in language', () => {
      expect(i18n.t('simple_de', { lng: 'de-DE' })).toBe('ok_from_de');
    });
    ...
    describe.skip('[WONT FIX - HARD DEPRECATION OF SYNC LOADING]with language not preloaded', () => {
      it('it should provide translation for passed in language after loading file sync', () => {
        ...
        expect(i18n.t('simple_fr', { lng: 'fr' })).toBe(expectedValue);
      });
    });
  });
  ...
  describe('using sprintf', () => {
    ...
    it('it should recognize the defaultValue syntax set as shortcutFunction', () => {
      expect(i18n.t('notFound', 'second param defaultValue')).toBe('second param defaultValue');
    });
  });
});
