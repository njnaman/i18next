/**
 * EventEmitter implementation for i18next TypeScript migration
 */

import type { EventEmitterInterface, EventObservers, EventListener } from '../types';

export default class EventEmitter implements EventEmitterInterface {
  public readonly observers: EventObservers;
